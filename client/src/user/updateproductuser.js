...
const UpateProductUSer = () => {
  ...
  async function HandleUpdateProduct(e) {
    ...
    try {
      const response = await fetch(
        `https://ayushreactbackend.onrender.com/api/v1/product/update-product/${Singleproduct}`,
        {
          method: "PUT",
          headers: {
  ...
  async function HandleDelete() {
    try {
      ...
      if (!answer) {
        ...
        const response = await fetch(
          `https://ayushreactbackend.onrender.com/api/v1/product/Delete-product/${Singleproduct}`,
          {
            method: "delete",
            headers: {
              Authorization: auth?.token,
          ...
          <div className="w-75">
            <form onSubmit={HandleUpdateProduct}>
              ...
              <div className="mt-4 d-flex flex-column align-items-center">
                ...
                <img
                  style={{ width: "5rem" }}
                  src={`https://ayushreactbackend.onrender.com/api/v1/product/get-productPhoto/${Pid}`}
                ></img>
              </div>
